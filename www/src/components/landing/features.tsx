      ...
      <div className="mx-auto max-w-7xl px-4 pb-12 text-t3-purple-100 sm:px-6 lg:px-8">
        ...
        <div>
          <div className="space-y-10 sm:grid sm:grid-flow-col sm:grid-cols-2 sm:grid-rows-3 sm:gap-x-6 sm:gap-y-14 sm:space-y-0 md:grid-cols-3 md:grid-rows-2 lg:gap-x-8">
            ...
            <Card title="NextAuth.js" href="https://next-auth.js.org/">
              <img
              ...
              />
              <React.Fragment>
                When you need flexible, secure, and scalable auth, NextAuth.js
                is top notch. It ties into your existing database and provides a
                simple API to manage users and sessions.
              </React.Fragment>
            </Card>
          </div>
        </div>
